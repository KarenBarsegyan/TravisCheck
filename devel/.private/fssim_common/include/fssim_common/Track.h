...
struct Track_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _cones_left_type;
  _cones_left_type cones_left;

   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _cones_right_type;
  _cones_right_type cones_right;

   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _cones_orange_type;
  _cones_orange_type cones_orange;

   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _cones_orange_big_type;
  _cones_orange_big_type cones_orange_big;

   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _tk_device_start_type;
  _tk_device_start_type tk_device_start;

   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _tk_device_end_type;
...
struct Printer< ::fssim_common::Track_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::fssim_common::Track_<ContainerAllocator>& v)
  {
    ...
    s << indent << "cones_left[]" << std::endl;
    for (size_t i = 0; i < v.cones_left.size(); ++i)
    {
      s << indent << "  cones_left[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "    ", v.cones_left[i]);
    }
    s << indent << "cones_right[]" << std::endl;
    for (size_t i = 0; i < v.cones_right.size(); ++i)
    {
      s << indent << "  cones_right[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "    ", v.cones_right[i]);
    }
    s << indent << "cones_orange[]" << std::endl;
    for (size_t i = 0; i < v.cones_orange.size(); ++i)
    {
      s << indent << "  cones_orange[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "    ", v.cones_orange[i]);
    }
    s << indent << "cones_orange_big[]" << std::endl;
    for (size_t i = 0; i < v.cones_orange_big.size(); ++i)
    {
      s << indent << "  cones_orange_big[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "    ", v.cones_orange_big[i]);
    }
    s << indent << "tk_device_start[]" << std::endl;
    for (size_t i = 0; i < v.tk_device_start.size(); ++i)
    {
      s << indent << "  tk_device_start[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "    ", v.tk_device_start[i]);
    }
    s << indent << "tk_device_end[]" << std::endl;
    for (size_t i = 0; i < v.tk_device_end.size(); ++i)
    {
      s << indent << "  tk_device_end[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "    ", v.tk_device_end[i]);
    }
  }
};
