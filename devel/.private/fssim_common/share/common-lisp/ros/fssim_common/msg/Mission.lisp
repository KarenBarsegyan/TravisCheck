...
(cl:defmethod cl:initialize-instance :after ((m <Mission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fssim_common-msg:<Mission> is deprecated: use fssim_common-msg:Mission instead.")))
...
(cl:defmethod mission-val ((m <Mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fssim_common-msg:mission-val is deprecated.  Use fssim_common-msg:mission instead.")
  (mission m))

(cl:ensure-generic-function 'finished-val :lambda-list '(m))
(cl:defmethod finished-val ((m <Mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fssim_common-msg:finished-val is deprecated.  Use fssim_common-msg:finished instead.")
  (finished m))
