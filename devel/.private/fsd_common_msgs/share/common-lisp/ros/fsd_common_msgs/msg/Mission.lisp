...
(cl:defmethod cl:initialize-instance :after ((m <Mission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fsd_common_msgs-msg:<Mission> is deprecated: use fsd_common_msgs-msg:Mission instead.")))
