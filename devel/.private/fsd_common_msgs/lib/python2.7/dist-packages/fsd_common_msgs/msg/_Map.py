...
class Map(genpy.Message):
  _md5sum = "8ddb8bd148fb7730a132faec3d415fe0"
...
string data
"""
  __slots__ = ['header','cone_yellow','cone_blue','cone_orange']
  _slot_types = ['std_msgs/Header','fsd_common_msgs/Cone[]','fsd_common_msgs/Cone[]','fsd_common_msgs/Cone[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,cone_yellow,cone_blue,cone_orange
    ...
    try:
      ...
      for val1 in self.cone_blue:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.cone_orange)
      buff.write(_struct_I.pack(length))
      for val1 in self.cone_orange:
        _v5 = val1.position
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.color
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v20.data = str[start:end].decode('utf-8')
        else:
